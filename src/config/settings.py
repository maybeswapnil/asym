...
class Settings(BaseSettings):
    ...
    mongodb_url: str = Field(
        default="mongodb+srv://swapnil:<db_password>@swapnil.wfwy9.mongodb.net/?retryWrites=true&w=majority&appName=swapnil",
        env="MONGODB_URL"
    )
    mongodb_database: str = Field(default="mcq_quiz_platform", env="MONGODB_DATABASE")
    ...
    allowed_origins: str = Field(
        default="https://preview--cerebrum-challenge.lovable.app,http://localhost:3000,http://localhost:5173,http://localhost:8080",
        env="ALLOWED_ORIGINS"
    )
    ...
    allowed_headers: str = Field(
        default="Content-Type,Authorization,user-id,X-Requested-With,Accept,Origin",
        env="ALLOWED_HEADERS"
    )
